...
function valor(ctrl){
	...
	//Se condiciona para que el numero intruducido este entre el rango de numeros esperados
		...
		var opciones = ["<img src='images/Piedra.png' alt='Piedra'><figcaption>Piedra</figcaption>", "<img src='images/Tijera.png' alt='Tijera'><figcaption>Tijera</figcaption>", "<img src='images/Papel.png' alt='Papel'><figcaption>Papel</figcaption>", "<img src='images/Lagarto.png' alt='Lagarto'><figcaption>Lagarto</figcaption>", "<img src='images/Spock.png' alt='Spock'><figcaption>Spock</figcaption>"];
		...
		else if( (opcionUsuario==0 && opcionMaquina==1) || (opcionUsuario==1 && opcionMaquina==2) || (opcionUsuario==2 && opcionMaquina==0) || (opcionUsuario==0 && opcionMaquina==3) || (opcionUsuario==3 && opcionMaquina==4) || (opcionUsuario==4 && opcionMaquina==1) || (opcionUsuario==3 && opcionMaquina==2) || (opcionUsuario==2 && opcionMaquina==1) || (opcionUsuario==4 && opcionMaquina==0)){
			resultado = ganaste;
